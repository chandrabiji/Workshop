 ...
 /**
  ...
  public Order(final int argOrderId,
       final int argFoodId, final int argVendorId, final int argCustomerId, final int argNoOfItems,
           final String argOrderDateTime, final double argAmountToBePaid, final String argTokenNumber,
   ...
   * @return int object
   */
  public final int createCustomToken(final int a, final String b, final String c) {
  ...
  public final String getTokenNumber() {
     ...
     */
  public final void setTokenNumber(final String argTokenNumber) {
    this.tokenNumber = argTokenNumber;
  }
    /**
     * @return this status.
